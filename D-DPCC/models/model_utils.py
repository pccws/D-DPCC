...
def merge_two_frames(f1, f2, stride=4):
    f1_ = ME.SparseTensor(torch.cat([f1.F, torch.zeros_like(f1.F)], dim=-1), coordinates=f1.C, tensor_stride=8,
                          device=f1.device)
