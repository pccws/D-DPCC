...
if __name__ == '__main__':
    ...
    tmp_dir = os.getcwd()  # 服务器调试 服务器目录输出
    '''    '''
    ...
    _, out2, _, _, _, _ = model_test(input1, input2, device='cpu')  # device='cpu' 报错
    output = out2[-1]
    print(output.C.shape)  # output虽然特征通道数为16，但不用管特征，几何坐标部分是解码的点